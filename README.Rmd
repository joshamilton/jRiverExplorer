...
An example JRiver Media Library XML file is included in this package: `inst/extdata/library.xml`. Users can upload this file into the app to explore its features.
